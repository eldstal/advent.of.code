...
def get_input(day, cookie=None, cookie_file="cookie.txt", year=2024):
...
def get_test_input(day, cookie=None, cookie_file="cookie.txt", year=2024):
...
def post_result(day, part, value, cookie=None, cookie_file="cookie.txt", year=2024):
